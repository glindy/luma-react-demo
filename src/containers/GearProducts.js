    ...
    <div className="d-flex flex-row-bd h-100" style={{}}>
      <div className="hero-banner-text">
        <div className="titles grouped">
          <h1 className="title-right-white" style={{ textTransform: "uppercase", textShadow: "1px 1px #000000", }}>never go thirsty</h1>
          <h1 className="title-right-white" style={{ textTransform: "uppercase", textShadow: "1px 1px #000000", }}>with luma's hydration collection</h1>
        </div>
      </div>
    </div>
  </div>
