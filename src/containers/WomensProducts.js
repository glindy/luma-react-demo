    ...
    <div className="d-flex flex-row-bd h-100" style={{}}>
      <div className="hero-banner-text">
        <div className="titles grouped">
          <h4 className="subtitle-right">THE 2025 COLLECTION HAS ARRIVED</h4>
          <h1 className="title-right">UNLOCK YOUR NEXT LEVEL</h1>
          <h1 className="title-right"> WITH LUMAFLEX™ APPAREL</h1>
        </div>
      </div>
    </div>
  </div>
